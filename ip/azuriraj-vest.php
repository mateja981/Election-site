...
<html>
  ...
  ?> <img src="folder/Pobednik.jpg" sizes="(max-width: 2560px) 100vw, 2560px" class="image-news">
    <div class="cont-div"> <?php
    
    include('prikaz-vesti.php');
    
    ?> <div class="cont-info">
        <a href="#" class="cont-mail">Наслов вести</a>
        <a href="unesi-vest.html" class="login-btn right w-button">Ажурирај</a>
        <a href="#" class="login-btn w-button">Избриши</a>
      </div>
    </div>
  </body>
</html>